...
public class WarBallsConfig
{
	...
	public static int width =  1590;//500;//1450;//1200;//1300;//1900;//1580;//1590;//800;//1900;//1900;//900
	public static int height = 800;//800;//975;//775;//800;////1000;//1000;//1000;//750
	public static int tick = 3;
	
	public static int friendlyTeamCount = 33;
	public static int enemyTeamCount = 33;
	public static int sandBagCount = 5;
	public static int waveTimer = 10;
	...
	public static int sandBagsCarried = 2;
	public static int sandBagHealth = 25;
	public static int maxDeadTime = 0;
	...
	public static int maxHealthHeal = 10;
	public static int maxBleedHeal = 4;
	public static int maxHealthIncrease = 10;

	public static int friendlyHealth = 20;
	...
	public static int machineGunMaxClip = 60;
	public static float machineGunTracerGhost = 0.046f;
	public static int machineGunTracerCount = 5;
	public static int machineGunBulletType = 0; // 0 = bullet / 1 = laser
